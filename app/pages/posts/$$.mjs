...
export default function ({ html, state }) {
  ...
  return html`
      ...
      <site-layout>
        <article class="h-entry font-body leading3 mi-auto pb0 pb4-lg">
          <h1 class="p-name font-heading text3 tracking-1">${title}</h1>
          <p class='date dt-published text-1 italic mbe4'>${published}</p>
